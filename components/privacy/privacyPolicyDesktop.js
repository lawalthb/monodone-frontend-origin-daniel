...
export default function PrivacyPolicyDesktop(props) {
  return (
    <>
      <PrivacyPolicyContent
        details={`My Company (change this)​("us", "we", or "our") operates ​http://www.mysite.com 
        (change this)​(the "Site"). This page informs you of our policies regarding the collection, 
      ...
      <PrivacyPolicyContent
        details={`While using our Site, we may ask you to provide us with certain personally 
      ...
      <PrivacyPolicyContent
        details={`Like many site operators, we collect information that your browser sends 
                ...
                and other statistics. In addition, we may use third party services such as Google Analytics 
      ...
      <PrivacyPolicyContent
        details={`Cookies are files with small amount of data, which may include an anonymous unique identifier.
      ...
      <PrivacyPolicyContent
        details={`The security of your Personal Information is important to us, but
      ...
      <PrivacyPolicyContent
        details={`This Privacy Policy is effective as of ​(add date)​and will remain in effect 
                except with respect to any changes in its provisions in the future, which will be in effect 
                immediately after being posted on this page.  We reserve the right to update or change our 
                Privacy Policy at any time and you should check this Privacy Policy periodically. 
                Your continued use of the Service after we post any modifications to the Privacy Policy on 
                this page will constitute your acknowledgment of the modifications and your consent to abide 
      ...
      <PrivacyPolicyContent
        details={`If you have any questions about this Privacy Policy, please contact us.`}
      />
    </>
  );
}
