...
export default function OfficeMobile(props) {
  const {
    ...
    <>
      ...
      >
        ...
        >
          ...
          <input
            type="file"
            ref={hiddenFrontStoreInput}
            onChange={handleFrontStoreChange}
            style={{
              display: 'none',
            }}
          />
        ...
        >
          <Button
            onClick={handleInsideStoreClick}
            style={{
              display: 'flex',
              gap: '10px',
              background: 'transparent',
          ...
          <input
            type="file"
            ref={hiddenInsideStoreInput}
            onChange={handleInsideStoreChange}
            style={{
              display: 'none',
            }}
          />
        ...
        >
          <Button
            onClick={handleRegistrationDocumentsClick}
            style={{
              display: 'flex',
              gap: '10px',
              background: 'transparent',
          ...
          <input
            type="file"
            ref={hiddenRegistrationDocumentsInput}
            onChange={handleRegistrationDocumentsChange}
            style={{
              display: 'none',
            }}
          />
          {registrationDocuments.name ? (
            <Form.Label
              style={{
                fontSize: '12px',
                color: '#A6A6A6',
