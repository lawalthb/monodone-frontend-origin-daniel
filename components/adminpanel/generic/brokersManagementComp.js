...
export default function BrokersManagementComp(props) {
    const ref = useRef()

    const handleIsBrokersManagement = () => {
        props.setIsBrokersManagement(true)
        props.setIsBrokersRequest(false)
    }
    const handleIsBrokersRequest = () => {
        props.setIsBrokersRequest(true)
        props.setIsBrokersManagement(false)
    }

    useEffect(() => {
        if (props.isBrokersRequest) {
            props.setIsBrokersManagement(false)
        } else {
            props.setIsBrokersManagement(true)
        }
        ...
        <>
            ...
            <div style={{
                ...
                <Form.Label
                    ...
                    style={props.isBrokersManagement ? {
                        fontSize: "13px",
                        color: "#00902F",
                        fontFamily: 'Poppins',
                        fontStyle: "normal",
                        ...
                        fontStyle: "normal",
                        fontWeight: "500"
                    }}>BROKERS MANAGEMENT</Form.Label>
                <Form.Label
                    onClick={handleIsBrokersRequest}
                    style={props.isBrokersRequest ? {
                        fontSize: "13px",
                        color: "#00902F",
                        fontFamily: 'Poppins',
                        fontStyle: "normal",
