...
export default function DriverManagerManagementDetails(props) {
    ...
    const handleEdit = () => {
        const data = props.adminAgentData[driverManagerId]
        data.businessName = firstName + " " + lastName
        data.address = address
        data.phoneNumber = phoneNumber

        props.adminAgentData.splice(driverManagerId, 1, data)
        console.log("saved")
        setEditModal(false)
    }
    ...
    return (
        <>
            ...
            <Statistics
                ...
                setStatistics={setStatistics}
                caption={props.isDriversManagersManagement ? "Driver Manager Statistics" : undefined}
                handleStatistics={handleStatistics}
            />
            <Review
                review={review}
                setReview={setReview}
                caption={props.isDriversManagersManagement ? "Reviews" : undefined}
