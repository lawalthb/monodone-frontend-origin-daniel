...
export default function DriverManagersManagementComp(props) {
    const ref = useRef()

    const handleIsDriversManagersManagement = () => {
        props.setIsDriversManagersManagement(true)
        props.setIsDriversManagersRequest(false)
    }
    const handleIsDriversManagersRequest = () => {
        props.setIsDriversManagersRequest(true)
        props.setIsDriversManagersManagement(false)
    }

    useEffect(() => {
        if (props.isDriversManagersRequest) {
            props.setIsDriversManagersManagement(false)
        } else {
            props.setIsDriversManagersManagement(true)
        }
    ...
    return (
        <>
            ...
            <div style={{
                ...
                <Form.Label
                    onClick={handleIsDriversManagersManagement}
                    style={props.isDriversManagersManagement ? {
                        fontSize: "13px",
                        color: "#00902F",
                        fontFamily: 'Poppins',
                        fontStyle: "normal",
                        ...
                        fontStyle: "normal",
                        fontWeight: "500"
                    }}>MANAGERS MANAGEMENT</Form.Label>
                <Form.Label
                    onClick={handleIsDriversManagersRequest}
                    style={props.isDriversManagersRequest ? {
                        fontSize: "13px",
                        color: "#00902F",
                        fontFamily: 'Poppins',
                        fontStyle: "normal",
