...
export default function RemoveAdminModal(props) {
    ...
    return (
        <GeneralModal
            size="md"
            show={props.removeAdmin}
            onHide={() => props.setRemoveAdmin(false)}
        >
            <>
                <Modal.Header
                    style={{
                ...
                <Modal.Body>
                    ...
                    <div className={styles.flex_between}>
                        <Button
                            onClick={() => props.setRemoveAdmin(false)}
                            style={{
                                background: "white",
                        ...
                        <Button
                            ...
                            onClick={props.handleConfirmRemove}
                            style={{
                                background: "#00902F",
                                border: "1px solid #00902F",
                                color: "white",
