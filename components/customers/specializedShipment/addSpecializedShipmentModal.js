...
import SpecializedShipmentDesktop from "./specializedShipmentDesktop";
import SpecializedShipmentMobile from "./specializedShipmentMobile";
import Media from "@/utils/media";

export default function AddSpecializedShipmentModal(props) {
    ...
    return (
        <>
            {mobile && (
                <GeneralModal
                    size="sm"
                    show={props.addSpecializedShipmentModal}
                    onHide={() => props.setAddSpecializedShipmentModal(false)}
                >
                    <div style={{
                        display: 'flex',
