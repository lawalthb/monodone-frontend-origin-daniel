...
export default function OrderModalIssued(props) {
    return (
        <GeneralModal
            size="lg"
            show={props.issued}
            onHide={() => props.setIssued(false)}
        >
            <Form className={styles.modal} style={{ padding: "50px" }}>
                <Form.Group className="mb-3">
                    ...
                    <Form.Label style={{ float: "right" }}>
                        <Button
                            onClick={props.handleTransitionAlert}
                            style={{
                                background: "white",
                                color: "#6FCF97",
                                borderRadius: "6px",
                ...
                <Form.Group className="mb-3">
                    <Form.Label style={{ fontSize: "12px" }}>
                        <CircleIcon style={{ fontSize: "12px", color: "#151515" }} /> Issued
                    </Form.Label>
                </Form.Group>
                ...
                <Form.Group
                    style={{ padding: "9px", marginTop: "10px" }}
                    className="mt-2"
                >
                    <Image
                        alt="Issued"
                        src="/img/issuedImg.png"
                        width={300}
                        height={300}
                        style={{
                            display: "flex",
                ...
                <Form.Group>
                    <Form.Label onClick={() => handleDriverRate()}>
