...
export default function PostLoadFailureModal(props) {
    return (
        <GeneralModal
            size="738px"
            show={props.postLoadFailure}
            onHide={() => props.setPostLoadFailure(false)}
            style={{ marginTop: "5%" }}
        >
            <Modal.Body style={{ padding: "40px 40px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", }}>
                    ...
                    <Form.Label style={{
                        ...
                        Sorry, your load to the load board is not completed due to network problem
                    </Form.Label>
                </div>
                <div style={{
